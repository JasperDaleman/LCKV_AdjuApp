...
import PyQt5
from PyQt5.QtWidgets import QWidget, QPushButton, QComboBox, QLineEdit, QGridLayout, QLabel
...
class InlegEnTentindeling(QWidget):
    ...
    def conf(self):
        ...
        self.master.personen.at[self.master.personen[self.master.personen.Naam == naam].index, 'Tent'] = self.tent.currentText()
        self.master.personen.at[self.master.personen[self.master.personen.Naam == naam].index, 'Barcode'] = self.bc.text()
