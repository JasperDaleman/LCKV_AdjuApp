...
# from InvoerenDeelnemers import InvoerenDeelnemers
#from TentIndeling import TentenIndeling
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, master):
        ...
        self.screens = {'HomeScreen': HomeScreen, 
                        'KampHome': KampHome,
    ...
    def setup_menus(self):
        ...
        #self.c.triggered.connect(QtWidgets.QApplication.quit)
        ...
        #self.inleggen = QtWidgets.QAction('&Invoeren Inleg ...', self)
        #self.inleggen.triggered.connect(self.inleggen_geld)
        
        self.fm.addAction(self.begr)
        self.fm.addAction(self.adn)
        self.fm.addAction(self.ti)
        self.fm.addAction(self.tw) 
        #self.fm.addAction(self.inleggen)
    ...
    def enter_dn(self):
#        self.wdg = InvoerenDeelnemers(self.master)
 #       self.wdg.show()
    ...
    def enter_tents(self):
        #self.tentindeling = TentenIndeling(self.master)
        #self.tentindeling.show()
