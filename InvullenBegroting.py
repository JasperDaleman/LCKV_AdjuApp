import PyQt5
from PyQt5.QtWidgets import QWidget, QLineEdit, QPushButton, QComboBox, QGridLayout, QLabel, QRadioButton, QButtonGroup, QMessageBox
    ...
    def bev(self):
        ...
        try:
            ...
            if self.outdoor_rb2.isChecked():
                outdoor *= (len(self.master.master.personen[self.master.master.personen.Functie == 'Deelnemer']) + int(self.stafsupport.text()))
            ...
            s = pd.Series([kampn, kampl, voeding, vb, outdoor, fooi, fuel, pres],
                          index=['Kampnummer', 'Locatie', 'Voeding', 'Vrije besteding',
            ...
            msgbox.setText('Er is ergens een foute waarde ingevoerd, controleer gegevens')
            msgbox.setStandardButtons(QMessageBox.Ok)
            msgbox.exec_()
