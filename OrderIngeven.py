...
class OrderIngeven(QWidget):
    ...
    def setup_table(self):
        ...
        self.table.setHorizontalHeaderLabels(
            ["Regelnummer"] + list(self.master.master.orders.columns)
        )
    ...
    def delete_line(self):
        if len(self.table.selectedItems()) > 0:
            ...
            StandaardFuncties.warning(
                self, "Geen rij geselecteerd!", "Regel verwijderen"
            )
    ...
    def confirm_order(self):
        ...
        self.master.master.orders = self.master.master.orders.append(
            self.orderlines, ignore_index=True, sort=False
        )
    ...
    def confirm_line(self):
        ...
        if prodc != "":
            try:
                prod = self.master.master.kantine.Productomschrijving.loc[
                    self.master.master.kantine.Productcode == prodc
                ].values[0]
                ...
                am = self.amount.text()
                bedr = self.master.master.kantine.Prijs.loc[
                    self.master.master.kantine.Productcode == prodc
                ].values[0] * int(am)
                ...
                self.orderlines = self.orderlines.append(
                    s, ignore_index=True, sort=False
                )
